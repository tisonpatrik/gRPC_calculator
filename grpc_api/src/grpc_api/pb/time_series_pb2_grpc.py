...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in time_series_pb2_grpc.py depends on'
...
class TimeSeriesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateTimeSeries = channel.unary_unary(
                '/TimeSeriesService/GenerateTimeSeries',
...
def add_TimeSeriesServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('TimeSeriesService', rpc_method_handlers)
